  ...
  return (
    <div className="max-w-4xl mx-auto min-h-screen flex flex-col items-center justify-center p-8">
      <div className="text-center mb-12 space-y-4">
        ...
        <p className="text-[#8B8680] text-lg max-w-md mx-auto">Select your primary role. You can always collaborate in different ways later.</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 w-full max-w-3xl">
        <button
          ...
          className={`group p-8 rounded-2xl border-2 transition-all text-left space-y-4 ${
            role === 'freelancer' 
            ? 'border-[#1C1C1C] bg-[#F5F2ED] shadow-md' 
            : 'border-[#D4CFCA] hover:border-[#1C1C1C] bg-white'
          }`}
        >
