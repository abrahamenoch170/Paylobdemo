    ...
    try {
      ...
      await fetch('/api/email/send', {
         ...
         body: JSON.stringify({
            ...
            subject: 'Milestone Approved & Settled!',
            template: 'milestone-settled',
            data: { milestoneId: id }
         })
      }).catch(e => console.log('Mock email error'));
  ...
  const handleRequestRevision = async () => {
    ...
    try {
      ...
      await fetch('/api/email/send', {
         ...
         body: JSON.stringify({
            to: 'freelancer@example.com',
            subject: 'Client Requested a Revision',
            template: 'revision-requested',
            data: { milestoneId: id, notes: revisionNotes }
         })
      }).catch(e => console.log('Mock email error'));
          ...
          {isLocked ? (
            <>
              ...
              <div className="space-y-3">
                ...
                <Button variant="tertiary" className="w-full gap-2 text-red-600 hover:bg-red-50 hover:text-red-700">
